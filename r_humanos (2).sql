...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-03-2022 a las 01:49:44
...
INSERT INTO `percepcion` (`id_percepcion`, `Descripcion`, `id_periodo`, `Dia`, `Mes`, `Nom_Per`, `Tipo_nom`, `Valor`, `Dia_per`) VALUES
(1, 'intento1', 1, 1, 12, 'p', 1, 1, 1),
(2, 'intento2', 2, 4, 4, 'P', 2, 0, 1),
(3, 'intento3', 1, 6, 4, 'N', 2, 0, 1);
...
INSERT INTO `periodo` (`Id_periodo`, `Descripcion`) VALUES
(1, 'Anual'),
(2, 'Mensual'),
(3, 'Semanal'),
(4, 'Semestral');
...
--
ALTER TABLE `percepcion`
  MODIFY `id_percepcion` int(18) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
